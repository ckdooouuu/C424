...
public class VpnStatus {
    public static ConnectStatusListener connectStatusListener;

//    public static void setConnectStatusListener(ConnectStatusListener connectStatusListener) {
//        Log.d("zjh", "set set set set set set set set set");
//        VpnStatus.connectStatusListener = connectStatusListener;
//    }

    public interface ConnectStatusListener {
        void connectStatus(ConnectionStatus level);
    }
    ...
    public class ConnectionStatusModel {
        ...
        public ConnectionStatusModel(ConnectionStatus connectionStatus, long timestamp) {
    ...
    private static ArrayList<ConnectionStatusModel> statusList = new ArrayList<>();
...
//        Log.d("zjh", "level:" + level);
//        if (connectStatusListener != null) {
//            Log.d("zjh", "BBBBBBBBBBBBBBBBBBBBBB");
//            connectStatusListener.connectStatus(level);
//        } else {
//            Log.d("zjh", "null null null null null null  BBBBBBBBBBBBBBBBBBBBBB");
//        }
    }
